...
const blogConfig = [
    ...
    {
        id: "blog-0",
        title: "Demystifying the Meaning of Underscores (_) in Python",
        links: [
            {
                name: "article",
                url: "https://medium.com/@leandrodestefani/desmistificando-o-significado-dos-underscores-em-python-6b0a78ec9f4c",
                icon: <SiMedium/>
            }
        ],
